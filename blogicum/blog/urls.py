...
urlpatterns = [
    ...
    path('posts/<int:pk>/edit/', login_required(
    ...
    path('edit_profile/', login_required(
     ...
     name='edit_profile'),
    path('posts/<int:pk>/comment/', login_required(
     views.CommentAddView.as_view()),
     name='add_comment'),
    path('posts/<int:pk>/edit_comment/<int:id>/', login_required(
     views.CommentUpdateView.as_view()),
     name='edit_comment'),
    path('posts/<int:pk>/delete_comment/<int:id>/', login_required(
